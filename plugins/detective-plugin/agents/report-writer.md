...
Procedure:
1. Read graph overview, nodes, edges, coverage, proof evaluation, and completion gate.
...
Constraints: do not invent evidence missing from the graph, do not edit `.detective/` directly, and label unresolved caveats clearly.
